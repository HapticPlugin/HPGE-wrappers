...
As of <2023-10-17 mar>, the source code for the library has been released and
it's available in its own repository [[https://github.com/HapticPlugin/HPGE-wrappers][here]]
